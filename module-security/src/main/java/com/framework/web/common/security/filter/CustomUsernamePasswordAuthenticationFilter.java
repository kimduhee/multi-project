...
import com.framework.web.common.security.dto.LoginJwtTokenDto;
...
public class CustomUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        try {
            ...
            log.error("- CustomUsernamePasswordAuthenticationFilter RuntimeException : {}", e.getMessage());
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        //JWT Token 생성
        String jwtToken = JwtUtil.createJWT(principalDetails.getUserInfo().getUserId(), secretKey);
